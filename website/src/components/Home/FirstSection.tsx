...
export default component$(() => {
  ...
  return (
    <div class="containerFirstSection bg-coolgray-900">
      ...
      <p  class="color-white m-2 animate-forwards animate-duration-1s animate-ease animate-fade-in-up">lerne professionel <a href="/programming/start" class="color-white bg-blue-500 p-1 border-rd">programmieren</a> und <a href="/other" class="color-white bg-rose-700 p-1 border-rd">alles</a> was dazu gehört</p>
    </div>
  );
})